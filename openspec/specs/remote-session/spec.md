...
Defines the persistent remote tmux session reached over SSH: attaching to or creating it, running the resolved remote command inside it, and reporting its liveness after detach.
